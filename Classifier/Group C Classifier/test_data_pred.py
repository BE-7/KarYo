...
rootdir = 'F:/dbit/sem 7/BE Project/Classifier/2 Level Classification/test/test_images_Group C'
...
chr_6 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_7 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_8 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_9 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_10 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_11 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_12 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_x = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
	...
	for subdir, dirs, files in os.walk(rootdir): 
		for file in files:
			...
			if(lname1[0]=="9"):
				chr_9["chr_"+name[1]] += 1
			if(lname1[0]=="10"):
				chr_10["chr_"+name[1]] += 1
			if(lname1[0]=="11"):
				chr_11["chr_"+name[1]] += 1
			if(lname1[0]=="12"):
				chr_12["chr_"+name[1]] += 1
			if(lname1[0]=="x"):
				chr_x["chr_"+name[1]] += 1
