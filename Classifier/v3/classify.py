...
def classify(imagePath):
	...
	with tf.gfile.FastGFile("G:/Karyotyping/Classifier/v3/tf_files/retrained_graph.pb", 'rb') as f:
	...
	with tf.Session() as sess:
		for file in filename:
			...
			label_lines = [line.rstrip() for line in tf.gfile.GFile("G:/Karyotyping/Classifier/v3/tf_files/retrained_labels.txt")]
