...
rootdir = 'F:/dbit/sem 7/BE Project/Classifier/2 Level Classification/test/test_images_Group B'
...
chr_4 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_5 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
