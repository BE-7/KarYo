...
rootdir = 'F:/dbit/sem 7/BE Project/Classifier/2 Level Classification/test/test_images_Group D'
...
chr_13 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_14 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_15 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
...
with tf.Session() as sess:
	for subdir, dirs, files in os.walk(rootdir): 
		for file in files:
			...
			if(lname1[0]=="13"):
				chr_13["chr_"+name[1]] += 1
			if(lname1[0]=="14"):
				chr_14["chr_"+name[1]] += 1
			if(lname1[0]=="15"):
				chr_15["chr_"+name[1]] += 1
