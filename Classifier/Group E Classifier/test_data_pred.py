...
rootdir = 'F:/dbit/sem 7/BE Project/Classifier/2 Level Classification/test/test_images_Group E'
...
chr_16 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_17 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_18 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
...
with tf.Session() as sess:
	for subdir, dirs, files in os.walk(rootdir): 
		for file in files:
			...
			if(lname1[0]=="16"):
				chr_16["chr_"+name[1]] += 1
			if(lname1[0]=="17"):
				chr_17["chr_"+name[1]] += 1
			if(lname1[0]=="18"):
				chr_18["chr_"+name[1]] += 1
