...
rootdir = 'F:/dbit/sem 7/BE Project/Classifier/2 Level Classification/test/test_images_Group F'
...
chr_19 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
chr_20 = {new_list: 0 for new_list in a} 
#print(avg_threshold_score)
...
with tf.Session() as sess:
	for subdir, dirs, files in os.walk(rootdir): 
		for file in files:
			...
			if(lname1[0]=="19"):
				chr_19["chr_"+name[1]] += 1
			if(lname1[0]=="20"):
				chr_20["chr_"+name[1]] += 1
