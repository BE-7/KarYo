...
def groupF_Classifier(imageDir,filename):
	...
	threshold = {'chr_19': 0.9564688171081912, 'chr_20': 0.9385518025826827}


	with tf.gfile.FastGFile(cwd+"/Classifier/Group F Classifier/tf_files/retrained_graph.pb", 'rb') as f:
	...
	with tf.Session() as sess:
		for file in filename:
			...
			label_lines = [line.rstrip() for line in tf.gfile.GFile(cwd+"/Classifier/Group F Classifier/tf_files/retrained_labels.txt")]
